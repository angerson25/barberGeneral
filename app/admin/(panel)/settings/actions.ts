...
export async function updateSettingsAction(formData: FormData) {
  ...
  await supabase
    ...
    .update({
      ...
      open_time: String(formData.get("open_time") ?? "").trim() || "09:00",
      close_time: String(formData.get("close_time") ?? "").trim() || "20:00",
      slot_minutes: Number(formData.get("slot_minutes") ?? 30) || 30,
